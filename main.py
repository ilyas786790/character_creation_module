...
def attack(char_name: str, char_class: str) -> str:
    """Принемает в себя значения и выводит урон нанесённый противнику."""
    if char_class == 'warrior':
        return (f'{char_name} нанёс урон противнику равный '
                '{5 + randint(3, 5)}')
    if char_class == 'mage':
        return ('{char_name} нанёс урон противнику равный '
                '{5 + randint(5, 10)}')
    if char_class == 'healer':
        return (f'{char_name} нанёс урон противнику равный '
                '{5 + randint(-3, -1)}')
    return (f'{char_name} нанёс урон противнику равный')
    # Без этой строки flake8 не пропускал,-выводил ошибку R503


def defence(char_name: str, char_class: str) -> str:
    """Функция выводит значение блокированного урона."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Функция работает со значениями специальных умений."""
    if char_class == 'warrior':
    ...
    return (f'{char_name} применил спеуиальное умение')
    # Без этой строки flake8 не пропускал,-выводил ошибку R503
